...
const mainnav = document.querySelector('.cd-primary-nav')

barnavbutton.addEventListener('click', () =>
{mainnav.classList.toggle('responsive')}, false);

const barnavbutton2 = document.querySelector('.barnav2');
const mainnav2 = document.querySelector('.cd-secondary-nav')

barnavbutton2.addEventListener('click', () =>
{mainnav2.classList.toggle('responsive2')}, false);